...
| React (TS)  | react-ts/     | (LandingPage LESSON_LIST) | 🔒 **ts03 (Controlled Input) locked** — do not edit without explicit approval. ✅ ts01 (Counter) updated to content rules. Rest: apply same. |
