...
- Contains the same application code as **`main`**, but **`content/generated/react-ts/` is intentionally minimal**: only the **first three** React · TS lessons that are fully tested and **locked**:
