/**
 * Generates 100 Angular and 100 Vue problem engines from react_100_problems_improved.md.
 * Same problems/titles/descriptions/objectives as React JS/TS, with framework-specific seed code.
...
const NODES = [
  { id: "intro", type: "reveal", phase: "Problem", content: { tag: "PROBLEM #${n} (Angular)", title: ${JSON.stringify(p.title)}, body: ${JSON.stringify(p.description)}, usecase: "Same concept as React — implemented with Angular (signals, standalone components)." } },
  { id: "objectives", type: "objectives", phase: "Objectives", items: [
${itemsStr}
  ] },
  { id: "step1", type: "question", phase: "Step 1 of 3", paal: "Set up the initial structure and state needed for this problem in Angular.", answer_keywords: ["component", "signal", "import"], seed_code: ${JSON.stringify(angularSeed)}, feedback_correct: "✅ Step 1 done.", feedback_partial: "Add required setup.", feedback_wrong: "Set up structure", expected: "Initial setup" },
  { id: "step2", type: "question", phase: "Step 2 of 3", paal: "Implement the core logic or template for this problem.", answer_keywords: ["template", "bind", "logic"], seed_code: ${JSON.stringify(angularSeed)}, feedback_correct: "✅ Step 2 done.", feedback_partial: "Core logic in place.", feedback_wrong: "Implement core", expected: "Core implementation" },
  { id: "step3", type: "question", phase: "Step 3 of 3", paal: "Wire everything together, handle edge cases, and export the component.", answer_keywords: ["export", "class"], seed_code: ${JSON.stringify(angularSeed)}, feedback_correct: "✅ Problem #${n} (Angular) complete.", feedback_partial: "Export and finish.", feedback_wrong: "Export component", expected: "Complete" },
];

const sideItems = [{ label: "Problem", id: "intro" }, { label: "Objectives", id: "objectives" }, { label: "Step 1", id: "step1" }, { label: "Step 2", id: "step2" }, { label: "Step 3", id: "step3" }];
export default createINPACTEngine({ NODES, sideItems, problemNum: ${n}, title: ${JSON.stringify(p.title)}, shortName: ${JSON.stringify(shortName)} });
`;
...
const NODES = [
  { id: "intro", type: "reveal", phase: "Problem", content: { tag: "PROBLEM #${n} (Vue)", title: ${JSON.stringify(p.title)}, body: ${JSON.stringify(p.description)}, usecase: "Same concept as React — implemented with Vue 3 (Composition API, ref, reactive)." } },
  { id: "objectives", type: "objectives", phase: "Objectives", items: [
${itemsStr}
  ] },
  { id: "step1", type: "question", phase: "Step 1 of 3", paal: "Set up the initial structure and state needed for this problem in Vue.", answer_keywords: ["ref", "script", "setup"], seed_code: ${JSON.stringify(vueSeed)}, feedback_correct: "✅ Step 1 done.", feedback_partial: "Add required setup.", feedback_wrong: "Set up structure", expected: "Initial setup" },
  { id: "step2", type: "question", phase: "Step 2 of 3", paal: "Implement the core logic or template for this problem.", answer_keywords: ["template", "bind", "logic"], seed_code: ${JSON.stringify(vueSeed)}, feedback_correct: "✅ Step 2 done.", feedback_partial: "Core logic in place.", feedback_wrong: "Implement core", expected: "Core implementation" },
  { id: "step3", type: "question", phase: "Step 3 of 3", paal: "Wire everything together, handle edge cases, and export the component.", answer_keywords: ["script", "template"], seed_code: ${JSON.stringify(vueSeed)}, feedback_correct: "✅ Problem #${n} (Vue) complete.", feedback_partial: "Export and finish.", feedback_wrong: "Export component", expected: "Complete" },
];
