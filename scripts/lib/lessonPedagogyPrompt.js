...
- For cured.steps, an object keyed by step id (e.g. "step3"). Each value only includes fields you change: "title", "phase", "instruction", "hint", "analogousExample", "expectedOutcome", "successCriteria", "feedbackCorrect", "feedbackPartial", "feedbackWrong". Do not remove evaluation blocks; you may leave them unchanged by omitting them.
