...
const NODES = [
  { id: "intro", type: "reveal", phase: "Problem", content: { tag: "PROBLEM #76", title: "Mini Redux", body: "Global state with useReducer + Context + useSelector-style hook", usecase: "Mini Redux." } },
