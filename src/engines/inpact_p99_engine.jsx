...
const NODES = [
  { id: "intro", type: "reveal", phase: "Problem", content: { tag: "PROBLEM #99", title: "Design Permission System", body: "Can action resource component, roles data model", usecase: "Permissions." } },
