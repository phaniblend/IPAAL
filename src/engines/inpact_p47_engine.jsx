...
const NODES = [
  { id: "intro", type: "reveal", phase: "Problem", content: { tag: "PROBLEM #47", title: "Compound Component (Tabs)", body: "Tabs component with Context so Tab children know active state", usecase: "Tabs + Context." } },
