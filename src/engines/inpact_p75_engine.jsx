...
const NODES = [
  { id: "intro", type: "reveal", phase: "Problem", content: { tag: "PROBLEM #75", title: "useLayoutEffect vs useEffect", body: "Explain difference with DOM measurement example", usecase: "Layout effect." } },
