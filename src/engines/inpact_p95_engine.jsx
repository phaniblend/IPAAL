...
const NODES = [
  { id: "intro", type: "reveal", phase: "Problem", content: { tag: "PROBLEM #95", title: "Test Error Boundary", body: "Test that throws in child, assert fallback UI", usecase: "Test error boundary." } },
