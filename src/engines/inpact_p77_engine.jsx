...
const NODES = [
  { id: "intro", type: "reveal", phase: "Problem", content: { tag: "PROBLEM #77", title: "Optimistic UI", body: "Todo: add item instantly, sync server, rollback on failure", usecase: "Optimistic updates." } },
