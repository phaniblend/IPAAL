...
const NODES = [
  { id: "intro", type: "reveal", phase: "Problem", content: { tag: "PROBLEM #53", title: "Lazy Loading Routes", body: "Code splitting with React.lazy + Suspense on routes", usecase: "Lazy routes." } },
