...
const NODES = [
  { id: "intro", type: "reveal", phase: "Problem", content: { tag: "PROBLEM #43", title: "Cart Context", body: "Shopping cart: add, remove, update quantity, total price", usecase: "Global cart state." } },
