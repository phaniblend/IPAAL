...
const NODES = [
  { id: "intro", type: "reveal", phase: "Problem", content: { tag: "PROBLEM #39", title: "useOnlineStatus", body: "Track whether the user is online or offline", usecase: "Show banner when offline." } },
