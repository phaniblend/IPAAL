...
const NODES = [
  { id: "intro", type: "reveal", phase: "Problem", content: { tag: "PROBLEM #74", title: "useDeferredValue", body: "Defer expensive re-render, keep input responsive", usecase: "Deferred value." } },
