...
const NODES = [
  { id: "intro", type: "reveal", phase: "Problem", content: { tag: "PROBLEM #54", title: "Image Lazy Loading", body: "Image loads when in viewport (IntersectionObserver)", usecase: "Lazy images." } },
