...
const NODES = [
  { id: "intro", type: "reveal", phase: "Problem", content: { tag: "PROBLEM #66", title: "Discriminated Union Props", body: "Button: variant=link requires href, variant=action requires onClick", usecase: "Discriminated unions." } },
