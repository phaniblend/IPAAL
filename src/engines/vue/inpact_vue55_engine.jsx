...
const NODES = [
  { id: "intro", type: "reveal", phase: "Lesson", content: { tag: "LESSON #55 (Vue)", title: "HOC withAuth", body: "withAuth HOC that redirects unauthenticated users", usecase: "Same concept as React — implemented with Vue 3 (Composition API, ref, reactive)." } },
