...
const NODES = [
  { id: "intro", type: "reveal", phase: "Lesson", content: { tag: "LESSON #75 (Vue)", title: "useLayoutEffect vs useEffect", body: "Explain difference with DOM measurement example", usecase: "Same concept as React — implemented with Vue 3 (Composition API, ref, reactive)." } },
