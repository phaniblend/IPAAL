...
const NODES = [
  { id: "intro", type: "reveal", phase: "Lesson", content: { tag: "LESSON #26 (Vue)", title: "Controlled vs Uncontrolled", body: "Explain the difference with a working example of each. Build (1) a controlled input: value and onChange from state. (2) An uncontrolled input: useRef to read the value when needed (e.g. on button click).", usecase: "Same concept as React — implemented with Vue 3 (Composition API, ref, reactive)." } },
