...
const NODES = [
  { id: "intro", type: "reveal", phase: "Problem", content: { tag: "PROBLEM #61 (Vue)", title: "Pagination", body: "Client-side pagination for 100 items", usecase: "Same concept as React — implemented with Vue 3 (Composition API, ref, reactive)." } },
