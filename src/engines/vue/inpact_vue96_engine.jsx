...
const NODES = [
  { id: "intro", type: "reveal", phase: "Lesson", content: { tag: "LESSON #96 (Vue)", title: "Design DataTable API", body: "Design props for sortable, filterable, paginated table", usecase: "Same concept as React — implemented with Vue 3 (Composition API, ref, reactive)." } },
