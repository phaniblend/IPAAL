...
const NODES = [
  { id: "intro", type: "reveal", phase: "Problem", content: { tag: "PROBLEM #50 (Vue)", title: "useCallback for Stable References", body: "Stabilise callback so child does not re-render", usecase: "Same concept as React — implemented with Vue 3 (Composition API, ref, reactive)." } },
