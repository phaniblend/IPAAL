...
const NODES = [
  { id: "intro", type: "reveal", phase: "Problem", content: { tag: "PROBLEM #43 (Vue)", title: "Cart Context", body: "Shopping cart: add, remove, update quantity, total price", usecase: "Same concept as React — implemented with Vue 3 (Composition API, ref, reactive)." } },
