...
const NODES = [
  { id: "intro", type: "reveal", phase: "Problem", content: { tag: "PROBLEM #56 (Vue)", title: "Render Props (MouseTracker)", body: "MouseTracker using render props pattern", usecase: "Same concept as React — implemented with Vue 3 (Composition API, ref, reactive)." } },
