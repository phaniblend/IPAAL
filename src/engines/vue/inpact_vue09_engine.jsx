...
const NODES = [
  { id: "intro", type: "reveal", phase: "Lesson", content: { tag: "LESSON #9 (Vue)", title: "Color Picker", body: "Change the background color of a div based on a dropdown selection. Build a <select> with options (e.g. Red, Green, Blue) and a div. When the user picks a color from the dropdown, the div's background updates to that color.", usecase: "Same concept as React — implemented with Vue 3 (Composition API, ref, reactive)." } },
