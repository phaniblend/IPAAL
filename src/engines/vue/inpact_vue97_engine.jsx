...
const NODES = [
  { id: "intro", type: "reveal", phase: "Problem", content: { tag: "PROBLEM #97 (Vue)", title: "Design Auth Flow", body: "Login, token storage, refresh, protected routes, logout", usecase: "Same concept as React — implemented with Vue 3 (Composition API, ref, reactive)." } },
