...
const NODES = [
  { id: "intro", type: "reveal", phase: "Lesson", content: { tag: "LESSON #97 (Vue)", title: "Design Auth Flow", body: "Login, token storage, refresh, protected routes, logout", usecase: "Same concept as React — implemented with Vue 3 (Composition API, ref, reactive)." } },
