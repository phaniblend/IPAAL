...
const NODES = [
  { id: "intro", type: "reveal", phase: "Problem", content: { tag: "PROBLEM #94 (Vue)", title: "Test Context", body: "Test component consuming Auth Context with mock provider", usecase: "Same concept as React — implemented with Vue 3 (Composition API, ref, reactive)." } },
