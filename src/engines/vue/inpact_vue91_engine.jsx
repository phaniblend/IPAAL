...
const NODES = [
  { id: "intro", type: "reveal", phase: "Lesson", content: { tag: "LESSON #91 (Vue)", title: "Test useFetch", body: "Test useFetch with renderHook, mock fetch, loading/error/data", usecase: "Same concept as React — implemented with Vue 3 (Composition API, ref, reactive)." } },
