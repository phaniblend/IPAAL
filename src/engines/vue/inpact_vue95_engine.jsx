...
const NODES = [
  { id: "intro", type: "reveal", phase: "Problem", content: { tag: "PROBLEM #95 (Vue)", title: "Test Error Boundary", body: "Test that throws in child, assert fallback UI", usecase: "Same concept as React — implemented with Vue 3 (Composition API, ref, reactive)." } },
