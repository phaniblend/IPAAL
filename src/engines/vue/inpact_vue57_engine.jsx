...
const NODES = [
  { id: "intro", type: "reveal", phase: "Problem", content: { tag: "PROBLEM #57 (Vue)", title: "Controlled DatePicker", body: "Fully controlled DatePicker component", usecase: "Same concept as React — implemented with Vue 3 (Composition API, ref, reactive)." } },
