...
const NODES = [
  { id: "intro", type: "reveal", phase: "Lesson", content: { tag: "LESSON #54 (Vue)", title: "Image Lazy Loading", body: "Image loads when in viewport (IntersectionObserver)", usecase: "Same concept as React — implemented with Vue 3 (Composition API, ref, reactive)." } },
