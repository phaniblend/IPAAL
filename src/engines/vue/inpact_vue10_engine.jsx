...
const NODES = [
  { id: "intro", type: "reveal", phase: "Problem", content: { tag: "PROBLEM #10 (Vue)", title: "Multiple State Vars", body: "Build a registration form tracking: name, email, password, and confirmPassword as separate state variables. Each field is controlled by its own useState. Display the current values (or a summary) so you can see all four updating as the user types.", usecase: "Same concept as React — implemented with Vue 3 (Composition API, ref, reactive)." } },
