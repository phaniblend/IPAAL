...
const NODES = [
  { id: "intro", type: "reveal", phase: "Lesson", content: { tag: "LESSON #77 (Vue)", title: "Optimistic UI", body: "Todo: add item instantly, sync server, rollback on failure", usecase: "Same concept as React — implemented with Vue 3 (Composition API, ref, reactive)." } },
