...
const NODES = [
  { id: "intro", type: "reveal", phase: "Lesson", content: { tag: "LESSON #81 (Vue)", title: "Feature Flag Hook", body: "useFeatureFlag(flagName) from context", usecase: "Same concept as React — implemented with Vue 3 (Composition API, ref, reactive)." } },
