...
const NODES = [
  { id: "intro", type: "reveal", phase: "Problem", content: { tag: "PROBLEM #24 (Vue)", title: "Styled Component Pattern", body: "Build a themed button using CSS variables. Define --primary, --secondary on a wrapper or :root, and use them in inline styles or a style tag so the button reads var(--primary).", usecase: "Same concept as React — implemented with Vue 3 (Composition API, ref, reactive)." } },
