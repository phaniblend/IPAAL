...
const NODES = [
  { id: "intro", type: "reveal", phase: "Lesson", content: { tag: "LESSON #74 (Vue)", title: "useDeferredValue", body: "Defer expensive re-render, keep input responsive", usecase: "Same concept as React — implemented with Vue 3 (Composition API, ref, reactive)." } },
