...
const NODES = [
  { id: "intro", type: "reveal", phase: "Problem", content: { tag: "PROBLEM #88 (Vue)", title: "Bundle Analysis", body: "Webpack Bundle Analyzer + code splitting for slow load", usecase: "Same concept as React — implemented with Vue 3 (Composition API, ref, reactive)." } },
