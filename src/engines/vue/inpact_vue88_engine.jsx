...
const NODES = [
  { id: "intro", type: "reveal", phase: "Lesson", content: { tag: "LESSON #88 (Vue)", title: "Bundle Analysis", body: "Webpack Bundle Analyzer + code splitting for slow load", usecase: "Same concept as React — implemented with Vue 3 (Composition API, ref, reactive)." } },
