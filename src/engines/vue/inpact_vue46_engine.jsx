...
const NODES = [
  { id: "intro", type: "reveal", phase: "Problem", content: { tag: "PROBLEM #46 (Vue)", title: "useReducer vs useState", body: "Refactor multi-field form from useState to useReducer", usecase: "Same concept as React — implemented with Vue 3 (Composition API, ref, reactive)." } },
