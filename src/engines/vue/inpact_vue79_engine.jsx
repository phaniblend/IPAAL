...
const NODES = [
  { id: "intro", type: "reveal", phase: "Problem", content: { tag: "PROBLEM #79 (Vue)", title: "Polling Hook", body: "usePolling: refetch on interval, stop on unmount", usecase: "Same concept as React — implemented with Vue 3 (Composition API, ref, reactive)." } },
