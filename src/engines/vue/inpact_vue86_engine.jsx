...
const NODES = [
  { id: "intro", type: "reveal", phase: "Problem", content: { tag: "PROBLEM #86 (Vue)", title: "Race Condition Fix", body: "Fix stale API overwriting fresh — AbortController", usecase: "Same concept as React — implemented with Vue 3 (Composition API, ref, reactive)." } },
