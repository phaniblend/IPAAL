...
const NODES = [
  { id: "intro", type: "reveal", phase: "Problem", content: { tag: "PROBLEM #22 (Vue)", title: "Inline Styles", body: "Build a progress bar with dynamic width via inline styles. Use state (e.g. progress 0–100) and set the bar's width to progress + '%'.", usecase: "Same concept as React — implemented with Vue 3 (Composition API, ref, reactive)." } },
