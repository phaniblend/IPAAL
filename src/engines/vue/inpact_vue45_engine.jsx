...
const NODES = [
  { id: "intro", type: "reveal", phase: "Lesson", content: { tag: "LESSON #45 (Vue)", title: "Context Performance", body: "Fix Context that re-renders entire tree — split or memo", usecase: "Same concept as React — implemented with Vue 3 (Composition API, ref, reactive)." } },
