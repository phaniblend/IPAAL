...
const NODES = [
  { id: "intro", type: "reveal", phase: "Problem", content: { tag: "PROBLEM #16 (Vue)", title: "Conditional Rendering", body: "Show different UI based on: loading, error, empty, and data states. Build a component that has a state (e.g. status: 'loading' | 'error' | 'empty' | 'data') and renders a different message or content for each.", usecase: "Same concept as React — implemented with Vue 3 (Composition API, ref, reactive)." } },
