...
const NODES = [
  { id: "intro", type: "reveal", phase: "Problem", content: { tag: "PROBLEM #6 (Vue)", title: "List Rendering with map()", body: "A shopping list component. An array of items lives in state. Each item renders as a <li> element. items = ['Apples', 'Bread', 'Milk'] → • Apples • Bread • Milk Add an item → list grows. Remove one → list shrinks.", usecase: "Same concept as React — implemented with Vue 3 (Composition API, ref, reactive)." } },
