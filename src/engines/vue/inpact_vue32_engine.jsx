...
const NODES = [
  { id: "intro", type: "reveal", phase: "Lesson", content: { tag: "LESSON #32 (Vue)", title: "useDebounce", body: "Debounce any value by a configurable delay", usecase: "Same concept as React — implemented with Vue 3 (Composition API, ref, reactive)." } },
