...
const NODES = [
  { id: "intro", type: "reveal", phase: "Problem", content: { tag: "PROBLEM #38 (Vue)", title: "useKeyPress", body: "Detect when a specific keyboard key is pressed", usecase: "Same concept as React — implemented with Vue 3 (Composition API, ref, reactive)." } },
