...
const NODES = [
  { id: "intro", type: "reveal", phase: "Problem", content: { tag: "PROBLEM #49 (Vue)", title: "useMemo for Expensive Computation", body: "Filter + sort large list — memoize the result", usecase: "Same concept as React — implemented with Vue 3 (Composition API, ref, reactive)." } },
