...
const NODES = [
  { id: "intro", type: "reveal", phase: "Lesson", content: { tag: "LESSON #48 (Vue)", title: "Unnecessary Re-renders", body: "Fix performance bug with React.memo, useMemo, useCallback", usecase: "Same concept as React — implemented with Vue 3 (Composition API, ref, reactive)." } },
