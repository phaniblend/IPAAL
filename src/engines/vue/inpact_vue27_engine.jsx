...
const NODES = [
  { id: "intro", type: "reveal", phase: "Problem", content: { tag: "PROBLEM #27 (Vue)", title: "Simple Todo List", body: "Add, complete, delete todos — full CRUD with useState. State is an array of objects { id, text, done }. Add new todo, toggle done, delete by id.", usecase: "Same concept as React — implemented with Vue 3 (Composition API, ref, reactive)." } },
