...
const NODES = [
  { id: "intro", type: "reveal", phase: "Lesson", content: { tag: "LESSON #93 (Vue)", title: "Test User Interactions", body: "Test multi-step form: fill, Next, submit, success", usecase: "Same concept as React — implemented with Vue 3 (Composition API, ref, reactive)." } },
