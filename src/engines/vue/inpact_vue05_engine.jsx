...
const NODES = [
  { id: "intro", type: "reveal", phase: "Problem", content: { tag: "PROBLEM #5 (Vue)", title: "Conditional Rendering with Ternary", body: "A status card that shows different content based on a boolean. isLoggedIn = true → \"Welcome back!\" + Logout button isLoggedIn = false → \"Please sign in\" + Login button One state variable. Two completely different UIs.", usecase: "Same concept as React — implemented with Vue 3 (Composition API, ref, reactive)." } },
