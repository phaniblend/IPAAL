...
const NODES = [
  { id: "intro", type: "reveal", phase: "Lesson", content: { tag: "LESSON #37 (Vue)", title: "useClickOutside", body: "Detect clicks outside a referenced element — dropdowns/modals", usecase: "Same concept as React — implemented with Vue 3 (Composition API, ref, reactive)." } },
