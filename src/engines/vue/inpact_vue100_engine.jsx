...
const NODES = [
  { id: "intro", type: "reveal", phase: "Problem", content: { tag: "PROBLEM #100 (Vue)", title: "Design Real-Time Dashboard", body: "Poll 5 endpoints, intervals, stale indicators, errors", usecase: "Same concept as React — implemented with Vue 3 (Composition API, ref, reactive)." } },
