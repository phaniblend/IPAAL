...
const NODES = [
  { id: "intro", type: "reveal", phase: "Lesson", content: { tag: "LESSON #100 (Vue)", title: "Design Real-Time Dashboard", body: "Poll 5 endpoints, intervals, stale indicators, errors", usecase: "Same concept as React — implemented with Vue 3 (Composition API, ref, reactive)." } },
