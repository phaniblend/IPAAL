...
const NODES = [
  { id: "intro", type: "reveal", phase: "Problem", content: { tag: "PROBLEM #67 (Vue)", title: "useRef Typing", body: "Type useRef for DOM element vs mutable value", usecase: "Same concept as React — implemented with Vue 3 (Composition API, ref, reactive)." } },
