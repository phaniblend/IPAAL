...
const NODES = [
  { id: "intro", type: "reveal", phase: "Problem", content: { tag: "PROBLEM #69 (Vue)", title: "Generic useFetch<T>", body: "Add generics to useFetch for typed responses", usecase: "Same concept as React — implemented with Vue 3 (Composition API, ref, reactive)." } },
