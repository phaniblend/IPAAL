...
const NODES = [
  { id: "intro", type: "reveal", phase: "Lesson", content: { tag: "LESSON #60 (Vue)", title: "Recursive TreeView", body: "Recursive TreeView for nested folders", usecase: "Same concept as React — implemented with Vue 3 (Composition API, ref, reactive)." } },
