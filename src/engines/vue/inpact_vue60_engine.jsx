...
const NODES = [
  { id: "intro", type: "reveal", phase: "Problem", content: { tag: "PROBLEM #60 (Vue)", title: "Recursive TreeView", body: "Recursive TreeView for nested folders", usecase: "Same concept as React — implemented with Vue 3 (Composition API, ref, reactive)." } },
