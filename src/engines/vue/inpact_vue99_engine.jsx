...
const NODES = [
  { id: "intro", type: "reveal", phase: "Lesson", content: { tag: "LESSON #99 (Vue)", title: "Design Permission System", body: "Can action resource component, roles data model", usecase: "Same concept as React — implemented with Vue 3 (Composition API, ref, reactive)." } },
