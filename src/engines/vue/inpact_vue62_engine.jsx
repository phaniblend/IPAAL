...
const NODES = [
  { id: "intro", type: "reveal", phase: "Lesson", content: { tag: "LESSON #62 (Vue)", title: "Infinite Scroll", body: "Load more on scroll (IntersectionObserver)", usecase: "Same concept as React — implemented with Vue 3 (Composition API, ref, reactive)." } },
