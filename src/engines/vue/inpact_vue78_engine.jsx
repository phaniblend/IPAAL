...
const NODES = [
  { id: "intro", type: "reveal", phase: "Lesson", content: { tag: "LESSON #78 (Vue)", title: "Request Deduplication", body: "Fetch layer that prevents duplicate in-flight same URL", usecase: "Same concept as React — implemented with Vue 3 (Composition API, ref, reactive)." } },
