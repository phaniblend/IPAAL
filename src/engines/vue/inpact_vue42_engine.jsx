...
const NODES = [
  { id: "intro", type: "reveal", phase: "Problem", content: { tag: "PROBLEM #42 (Vue)", title: "Auth Context", body: "Mock auth: login, logout, protected route, user in context", usecase: "Same concept as React — implemented with Vue 3 (Composition API, ref, reactive)." } },
