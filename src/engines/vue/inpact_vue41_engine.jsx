...
const NODES = [
  { id: "intro", type: "reveal", phase: "Problem", content: { tag: "PROBLEM #41 (Vue)", title: "Theme Context", body: "Dark/light mode toggle using Context + useReducer", usecase: "Same concept as React — implemented with Vue 3 (Composition API, ref, reactive)." } },
