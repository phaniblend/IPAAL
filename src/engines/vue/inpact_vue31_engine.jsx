...
const NODES = [
  { id: "intro", type: "reveal", phase: "Lesson", content: { tag: "LESSON #31 (Vue)", title: "useFetch", body: "Custom hook for data fetching with loading/error/data + AbortController cleanup", usecase: "Same concept as React — implemented with Vue 3 (Composition API, ref, reactive)." } },
