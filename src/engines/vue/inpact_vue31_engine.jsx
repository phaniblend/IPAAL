...
const NODES = [
  { id: "intro", type: "reveal", phase: "Problem", content: { tag: "PROBLEM #31 (Vue)", title: "useFetch", body: "Custom hook for data fetching with loading/error/data + AbortController cleanup", usecase: "Same concept as React — implemented with Vue 3 (Composition API, ref, reactive)." } },
