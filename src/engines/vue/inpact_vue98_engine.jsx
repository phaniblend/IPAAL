...
const NODES = [
  { id: "intro", type: "reveal", phase: "Problem", content: { tag: "PROBLEM #98 (Vue)", title: "Design Notification System", body: "Toasts: types, auto-dismiss, max 3, queue", usecase: "Same concept as React — implemented with Vue 3 (Composition API, ref, reactive)." } },
