...
const NODES = [
  { id: "intro", type: "reveal", phase: "Lesson", content: { tag: "LESSON #66 (Vue)", title: "Discriminated Union Props", body: "Button: variant=link requires href, variant=action requires onClick", usecase: "Same concept as React — implemented with Vue 3 (Composition API, ref, reactive)." } },
