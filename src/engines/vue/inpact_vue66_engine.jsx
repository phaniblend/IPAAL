...
const NODES = [
  { id: "intro", type: "reveal", phase: "Problem", content: { tag: "PROBLEM #66 (Vue)", title: "Discriminated Union Props", body: "Button: variant=link requires href, variant=action requires onClick", usecase: "Same concept as React — implemented with Vue 3 (Composition API, ref, reactive)." } },
