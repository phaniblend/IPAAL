...
const NODES = [
  { id: "intro", type: "reveal", phase: "Lesson", content: { tag: "LESSON #44 (Vue)", title: "Notification Context", body: "Toast system: push, auto-dismiss, stack limit", usecase: "Same concept as React — implemented with Vue 3 (Composition API, ref, reactive)." } },
