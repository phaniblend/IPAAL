...
const NODES = [
  { id: "intro", type: "reveal", phase: "Problem", content: { tag: "PROBLEM #44 (Vue)", title: "Notification Context", body: "Toast system: push, auto-dismiss, stack limit", usecase: "Same concept as React — implemented with Vue 3 (Composition API, ref, reactive)." } },
