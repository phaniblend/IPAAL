...
const NODES = [
  { id: "intro", type: "reveal", phase: "Problem", content: { tag: "PROBLEM #53 (Vue)", title: "Lazy Loading Routes", body: "Code splitting with React.lazy + Suspense on routes", usecase: "Same concept as React — implemented with Vue 3 (Composition API, ref, reactive)." } },
