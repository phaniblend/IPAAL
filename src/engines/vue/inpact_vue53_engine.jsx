...
const NODES = [
  { id: "intro", type: "reveal", phase: "Lesson", content: { tag: "LESSON #53 (Vue)", title: "Lazy Loading Routes", body: "Code splitting with React.lazy + Suspense on routes", usecase: "Same concept as React — implemented with Vue 3 (Composition API, ref, reactive)." } },
