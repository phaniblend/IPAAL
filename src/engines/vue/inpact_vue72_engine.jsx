...
const NODES = [
  { id: "intro", type: "reveal", phase: "Problem", content: { tag: "PROBLEM #72 (Vue)", title: "useSyncExternalStore", body: "Subscribe to external store safely in concurrent mode", usecase: "Same concept as React — implemented with Vue 3 (Composition API, ref, reactive)." } },
