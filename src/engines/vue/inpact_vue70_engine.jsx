...
const NODES = [
  { id: "intro", type: "reveal", phase: "Lesson", content: { tag: "LESSON #70 (Vue)", title: "Utility Types", body: "Use Partial, Pick, Omit for prop interfaces", usecase: "Same concept as React — implemented with Vue 3 (Composition API, ref, reactive)." } },
