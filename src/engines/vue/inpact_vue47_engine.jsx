...
const NODES = [
  { id: "intro", type: "reveal", phase: "Problem", content: { tag: "PROBLEM #47 (Vue)", title: "Compound Component (Tabs)", body: "Tabs component with Context so Tab children know active state", usecase: "Same concept as React — implemented with Vue 3 (Composition API, ref, reactive)." } },
