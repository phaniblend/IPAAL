...
const NODES = [
  { id: "intro", type: "reveal", phase: "Lesson", content: { tag: "LESSON #47 (Vue)", title: "Compound Component (Tabs)", body: "Tabs component with Context so Tab children know active state", usecase: "Same concept as React — implemented with Vue 3 (Composition API, ref, reactive)." } },
