...
const NODES = [
  { id: "intro", type: "reveal", phase: "Problem", content: { tag: "PROBLEM #85 (Vue)", title: "Micro-frontend Shell", body: "Sketch React as micro-frontend with Module Federation", usecase: "Same concept as React — implemented with Vue 3 (Composition API, ref, reactive)." } },
