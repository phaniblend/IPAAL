...
const NODES = [
  { id: "intro", type: "reveal", phase: "Lesson", content: { tag: "LESSON #39 (Vue)", title: "useOnlineStatus", body: "Track whether the user is online or offline", usecase: "Same concept as React — implemented with Vue 3 (Composition API, ref, reactive)." } },
