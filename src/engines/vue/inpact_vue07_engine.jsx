...
const NODES = [
  { id: "intro", type: "reveal", phase: "Problem", content: { tag: "PROBLEM #7 (Vue)", title: "useEffect & Side Effects", body: "A document title updater. Every time the count changes, the browser tab title updates automatically. count = 0 → tab shows \"Count: 0\" count = 1 → tab shows \"Count: 1\" count = 5 → tab shows \"Count: 5\" No button click triggers this — it just happens whenever count changes.", usecase: "Same concept as React — implemented with Vue 3 (Composition API, ref, reactive)." } },
