...
const NODES = [
  { id: "intro", type: "reveal", phase: "Lesson", content: { tag: "LESSON #51 (Vue)", title: "React.memo", body: "Wrap pure child; demonstrate it stops re-rendering", usecase: "Same concept as React — implemented with Vue 3 (Composition API, ref, reactive)." } },
