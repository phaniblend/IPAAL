...
const NODES = [
  { id: "intro", type: "reveal", phase: "Lesson", content: { tag: "LESSON #59 (Vue)", title: "Error Boundary", body: "Class-based Error Boundary with fallback UI", usecase: "Same concept as React — implemented with Vue 3 (Composition API, ref, reactive)." } },
