...
const NODES = [
  { id: "intro", type: "reveal", phase: "Problem", content: { tag: "PROBLEM #21 (Vue)", title: "Conditional Classes", body: "Apply different CSS classes based on component state. Build a button or div that toggles an 'active' class (or multiple classes) when state is true/false.", usecase: "Same concept as React — implemented with Vue 3 (Composition API, ref, reactive)." } },
