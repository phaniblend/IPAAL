...
const NODES = [
  { id: "intro", type: "reveal", phase: "Problem", content: { tag: "PROBLEM #23 (Vue)", title: "CSS Modules", body: "Convert a component from global CSS to CSS Modules. Create a .module.css file, import it as styles, and use className={styles.box} instead of class=\"box\". Explain why modules scope class names.", usecase: "Same concept as React — implemented with Vue 3 (Composition API, ref, reactive)." } },
