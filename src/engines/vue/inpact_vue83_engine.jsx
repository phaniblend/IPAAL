...
const NODES = [
  { id: "intro", type: "reveal", phase: "Problem", content: { tag: "PROBLEM #83 (Vue)", title: "Form Library from Scratch", body: "Mini useForm: register, values/errors/touched, submit", usecase: "Same concept as React — implemented with Vue 3 (Composition API, ref, reactive)." } },
