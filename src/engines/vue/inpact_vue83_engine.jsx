...
const NODES = [
  { id: "intro", type: "reveal", phase: "Lesson", content: { tag: "LESSON #83 (Vue)", title: "Form Library from Scratch", body: "Mini useForm: register, values/errors/touched, submit", usecase: "Same concept as React — implemented with Vue 3 (Composition API, ref, reactive)." } },
