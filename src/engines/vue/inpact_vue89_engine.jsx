...
const NODES = [
  { id: "intro", type: "reveal", phase: "Problem", content: { tag: "PROBLEM #89 (Vue)", title: "Concurrent Mode Gotchas", body: "Explain tearing and useSyncExternalStore", usecase: "Same concept as React — implemented with Vue 3 (Composition API, ref, reactive)." } },
