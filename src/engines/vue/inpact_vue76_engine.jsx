...
const NODES = [
  { id: "intro", type: "reveal", phase: "Problem", content: { tag: "PROBLEM #76 (Vue)", title: "Mini Redux", body: "Global state with useReducer + Context + useSelector-style hook", usecase: "Same concept as React — implemented with Vue 3 (Composition API, ref, reactive)." } },
