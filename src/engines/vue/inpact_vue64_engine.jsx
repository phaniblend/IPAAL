...
const NODES = [
  { id: "intro", type: "reveal", phase: "Problem", content: { tag: "PROBLEM #64 (Vue)", title: "Multi-Step Form", body: "3-step form with validation, back/next, persisted state", usecase: "Same concept as React — implemented with Vue 3 (Composition API, ref, reactive)." } },
