...
const NODES = [
  { id: "intro", type: "reveal", phase: "Lesson", content: { tag: "LESSON #64 (Vue)", title: "Multi-Step Form", body: "3-step form with validation, back/next, persisted state", usecase: "Same concept as React — implemented with Vue 3 (Composition API, ref, reactive)." } },
