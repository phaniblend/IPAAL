...
const NODES = [
  { id: "intro", type: "reveal", phase: "Problem", content: { tag: "PROBLEM #33 (Vue)", title: "useLocalStorage", body: "Sync state with localStorage — read on mount, write on change", usecase: "Same concept as React — implemented with Vue 3 (Composition API, ref, reactive)." } },
