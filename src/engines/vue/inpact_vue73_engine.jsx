...
const NODES = [
  { id: "intro", type: "reveal", phase: "Problem", content: { tag: "PROBLEM #73 (Vue)", title: "useTransition", body: "Mark slow update non-urgent — heavy filtered list demo", usecase: "Same concept as React — implemented with Vue 3 (Composition API, ref, reactive)." } },
