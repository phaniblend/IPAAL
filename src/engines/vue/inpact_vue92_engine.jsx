...
const NODES = [
  { id: "intro", type: "reveal", phase: "Problem", content: { tag: "PROBLEM #92 (Vue)", title: "Test Async Component", body: "Test fetch component with msw, assert loading → data", usecase: "Same concept as React — implemented with Vue 3 (Composition API, ref, reactive)." } },
