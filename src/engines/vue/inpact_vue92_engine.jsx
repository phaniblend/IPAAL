...
const NODES = [
  { id: "intro", type: "reveal", phase: "Lesson", content: { tag: "LESSON #92 (Vue)", title: "Test Async Component", body: "Test fetch component with msw, assert loading → data", usecase: "Same concept as React — implemented with Vue 3 (Composition API, ref, reactive)." } },
