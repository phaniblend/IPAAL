...
const NODES = [
  { id: "intro", type: "reveal", phase: "Lesson", content: { tag: "LESSON #40 (Vue)", title: "useMediaQuery", body: "Return true/false based on a CSS media query string", usecase: "Same concept as React — implemented with Vue 3 (Composition API, ref, reactive)." } },
