...
const NODES = [
  { id: "intro", type: "reveal", phase: "Lesson", content: { tag: "LESSON #90 (Vue)", title: "Memory Leak Hunt", body: "Find and fix: listener, interval, subscription not cleaned", usecase: "Same concept as React — implemented with Vue 3 (Composition API, ref, reactive)." } },
