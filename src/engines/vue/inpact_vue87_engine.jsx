...
const NODES = [
  { id: "intro", type: "reveal", phase: "Lesson", content: { tag: "LESSON #87 (Vue)", title: "Memoization Strategy", body: "Dashboard with 20 widgets — memoization strategy", usecase: "Same concept as React — implemented with Vue 3 (Composition API, ref, reactive)." } },
