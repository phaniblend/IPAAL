...
const NODES = [
  { id: "intro", type: "reveal", phase: "Problem", content: { tag: "PROBLEM #63 (Vue)", title: "Debounced Search", body: "useDebounce + useFetch for real-time search", usecase: "Same concept as React — implemented with Vue 3 (Composition API, ref, reactive)." } },
