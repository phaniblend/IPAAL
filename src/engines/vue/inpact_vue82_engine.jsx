...
const NODES = [
  { id: "intro", type: "reveal", phase: "Lesson", content: { tag: "LESSON #82 (Vue)", title: "Undo/Redo", body: "Undo/redo for text editor with useReducer + history stack", usecase: "Same concept as React — implemented with Vue 3 (Composition API, ref, reactive)." } },
