...
const NODES = [
  { id: "intro", type: "reveal", phase: "Problem", content: { tag: "PROBLEM #82 (Vue)", title: "Undo/Redo", body: "Undo/redo for text editor with useReducer + history stack", usecase: "Same concept as React — implemented with Vue 3 (Composition API, ref, reactive)." } },
