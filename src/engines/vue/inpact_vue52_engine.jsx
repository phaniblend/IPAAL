...
const NODES = [
  { id: "intro", type: "reveal", phase: "Problem", content: { tag: "PROBLEM #52 (Vue)", title: "List Virtualization", body: "Windowing for 10,000 items (e.g. react-window)", usecase: "Same concept as React — implemented with Vue 3 (Composition API, ref, reactive)." } },
