...
const NODES = [
  { id: "intro", type: "reveal", phase: "Lesson", content: { tag: "LESSON #84 (Vue)", title: "Component Library Theming", body: "Token-based theming with CSS variables + Context", usecase: "Same concept as React — implemented with Vue 3 (Composition API, ref, reactive)." } },
