...
const NODES = [
  { id: "intro", type: "reveal", phase: "Lesson", content: { tag: "LESSON #13 (Vue)", title: "Props Drilling", body: "Pass data 3 levels deep. Build a small tree: App → Layer1 → Layer2 → Layer3, and pass a value (e.g. theme or user) from App down so Layer3 can display it. You'll see why passing through every layer gets tedious.", usecase: "Same concept as React — implemented with Vue 3 (Composition API, ref, reactive)." } },
