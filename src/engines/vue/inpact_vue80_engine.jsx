...
const NODES = [
  { id: "intro", type: "reveal", phase: "Problem", content: { tag: "PROBLEM #80 (Vue)", title: "WebSocket Hook", body: "useWebSocket: connect, reconnect, send + last message", usecase: "Same concept as React — implemented with Vue 3 (Composition API, ref, reactive)." } },
