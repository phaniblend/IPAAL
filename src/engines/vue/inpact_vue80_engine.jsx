...
const NODES = [
  { id: "intro", type: "reveal", phase: "Lesson", content: { tag: "LESSON #80 (Vue)", title: "WebSocket Hook", body: "useWebSocket: connect, reconnect, send + last message", usecase: "Same concept as React — implemented with Vue 3 (Composition API, ref, reactive)." } },
