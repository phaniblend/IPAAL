...
const NODES = [
  { id: "intro", type: "reveal", phase: "Lesson", content: { tag: "LESSON #36 (Vue)", title: "usePrevious", body: "Return the previous value of any state using useRef", usecase: "Same concept as React — implemented with Vue 3 (Composition API, ref, reactive)." } },
