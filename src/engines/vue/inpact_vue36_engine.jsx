...
const NODES = [
  { id: "intro", type: "reveal", phase: "Problem", content: { tag: "PROBLEM #36 (Vue)", title: "usePrevious", body: "Return the previous value of any state using useRef", usecase: "Same concept as React — implemented with Vue 3 (Composition API, ref, reactive)." } },
