...
const NODES = [
  { id: "intro", type: "reveal", phase: "Problem", content: { tag: "PROBLEM #14 (Vue)", title: "Default Props", body: "Build an Avatar component with default props for size (e.g. 40) and placeholder image URL. When the consumer doesn't pass image, show the placeholder.", usecase: "Same concept as React — implemented with Vue 3 (Composition API, ref, reactive)." } },
