...
const NODES = [
  { id: "intro", type: "reveal", phase: "Lesson", content: { tag: "LESSON #68 (Vue)", title: "Event Typing", body: "Type onChange, onClick, onSubmit in TypeScript", usecase: "Same concept as React — implemented with Vue 3 (Composition API, ref, reactive)." } },
