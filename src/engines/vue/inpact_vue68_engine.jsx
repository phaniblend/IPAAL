...
const NODES = [
  { id: "intro", type: "reveal", phase: "Problem", content: { tag: "PROBLEM #68 (Vue)", title: "Event Typing", body: "Type onChange, onClick, onSubmit in TypeScript", usecase: "Same concept as React — implemented with Vue 3 (Composition API, ref, reactive)." } },
