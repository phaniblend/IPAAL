...
const NODES = [
  { id: "intro", type: "reveal", phase: "Lesson", content: { tag: "LESSON #71 (Vue)", title: "useImperativeHandle", body: "Expose focus()/clear() from child via forwardRef + useImperativeHandle", usecase: "Same concept as React — implemented with Vue 3 (Composition API, ref, reactive)." } },
