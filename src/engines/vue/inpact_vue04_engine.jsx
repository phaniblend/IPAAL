...
const NODES = [
  { id: "intro", type: "reveal", phase: "Problem", content: { tag: "PROBLEM #4 (Vue)", title: "Multiple State Variables", body: "A profile card form with two independent inputs — name and age. Each input has its own state. Changing one doesn't affect the other. Example: name: [ Alice ] age: [ 30 ] → Hello, Alice! You are 30 years old.", usecase: "Same concept as React — implemented with Vue 3 (Composition API, ref, reactive)." } },
