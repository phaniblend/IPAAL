...
const NODES = [
  { id: "intro", type: "reveal", phase: "Lesson", content: { tag: "LESSON #58 (Vue)", title: "Portal", body: "Render modal outside root with ReactDOM.createPortal", usecase: "Same concept as React — implemented with Vue 3 (Composition API, ref, reactive)." } },
