...
const NODES = [
  { id: "intro", type: "reveal", phase: "Problem", content: { tag: "PROBLEM #50", title: "useCallback for Stable References", body: "Stabilise callback so child does not re-render", usecase: "Stable refs." } },
