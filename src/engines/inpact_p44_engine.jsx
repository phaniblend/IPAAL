...
const NODES = [
  { id: "intro", type: "reveal", phase: "Problem", content: { tag: "PROBLEM #44", title: "Notification Context", body: "Toast system: push, auto-dismiss, stack limit", usecase: "Global toasts." } },
