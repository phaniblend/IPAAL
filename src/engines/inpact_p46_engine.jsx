...
const NODES = [
  { id: "intro", type: "reveal", phase: "Problem", content: { tag: "PROBLEM #46", title: "useReducer vs useState", body: "Refactor multi-field form from useState to useReducer", usecase: "Complex form state." } },
