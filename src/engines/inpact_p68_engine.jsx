...
const NODES = [
  { id: "intro", type: "reveal", phase: "Problem", content: { tag: "PROBLEM #68", title: "Event Typing", body: "Type onChange, onClick, onSubmit in TypeScript", usecase: "Event types." } },
