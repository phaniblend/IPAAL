...
const NODES = [
  { id: "intro", type: "reveal", phase: "Problem", content: { tag: "PROBLEM #71", title: "useImperativeHandle", body: "Expose focus()/clear() from child via forwardRef + useImperativeHandle", usecase: "Imperative handle." } },
