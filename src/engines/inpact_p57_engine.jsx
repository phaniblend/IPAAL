...
const NODES = [
  { id: "intro", type: "reveal", phase: "Problem", content: { tag: "PROBLEM #57", title: "Controlled DatePicker", body: "Fully controlled DatePicker component", usecase: "Controlled pattern." } },
