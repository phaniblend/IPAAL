...
const NODES = [
  { id: "intro", type: "reveal", phase: "Problem", content: { tag: "PROBLEM #89", title: "Concurrent Mode Gotchas", body: "Explain tearing and useSyncExternalStore", usecase: "Tearing." } },
