...
const NODES = [
  { id: "intro", type: "reveal", phase: "Problem", content: { tag: "PROBLEM #92", title: "Test Async Component", body: "Test fetch component with msw, assert loading → data", usecase: "Test async." } },
