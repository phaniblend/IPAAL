...
const NODES = [
  { id: "intro", type: "reveal", phase: "Problem", content: { tag: "PROBLEM #1 (TypeScript)", title: "Counter App — Typed", body: "Build a counter component with increment, decrement, and reset buttons. Use TypeScript: make the state a number and give your component (and any props it receives) explicit types.", usecase: "Typing useState and handlers is the foundation for type-safe React." } },
  { id: "objectives", type: "objectives", phase: "Objectives", items: ["Start from a ready-made file (imports and Counter component shell are provided)", "Add a state variable for the count (numeric type, initial 0)", "Add handlers that update state, then wire all three buttons in the UI", "Export the typed function component"] },
...
const sideItems = [{ label: "Problem", id: "intro" }, { label: "Objectives", id: "objectives" }, { label: "Step 1", id: "step1" }, { label: "Step 2", id: "step2" }, { label: "Step 3", id: "step2jsx" }, { label: "Step 4", id: "step3" }];
