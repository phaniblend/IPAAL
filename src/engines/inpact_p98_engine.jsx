...
const NODES = [
  { id: "intro", type: "reveal", phase: "Problem", content: { tag: "PROBLEM #98", title: "Design Notification System", body: "Toasts: types, auto-dismiss, max 3, queue", usecase: "Notification design." } },
