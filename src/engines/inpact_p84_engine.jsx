...
const NODES = [
  { id: "intro", type: "reveal", phase: "Problem", content: { tag: "PROBLEM #84", title: "Component Library Theming", body: "Token-based theming with CSS variables + Context", usecase: "Theming." } },
