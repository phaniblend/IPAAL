...
// ─── ENGINE A01: COMPONENTS & DECORATORS ─────────────────────────────────────
...
const s = {
  ...
  tag: (color) => ({
    ...
    color: color === "purple" ? "#c4b5fd" : "#67e8f9",
  ...
  btn: (variant) => ({
    ...
    ...(variant === "primary"
      ...
      : { background: "transparent", border: "1px solid #2d3748", color: "#4a5568", fontSize: "11px" }),
  }),
  feedback: (type) => ({
    padding: "14px 18px",
    borderRadius: "8px",
  ...
  rubricItem: (checked) => ({
    ...
    borderRadius: "6px",
    cursor: "pointer",
    background: checked ? "rgba(16,185,129,0.08)" : "#1a1d2e",
    border: `1px solid ${checked ? "rgba(16,185,129,0.3)" : "#2d3748"}`,
    transition: "all 0.15s",
  }),
  rubricText: (checked) => ({
    fontSize: "13px",
    color: checked ? "#6ee7b7" : "#64748b",
    lineHeight: 1.5,
      ...
      <div>
        ...
        {showAnalogy && node.analogy ? (
          <div style={s.analogyCard}>
            ...
            <div style={{ fontSize: "13px", color: "#64748b", lineHeight: 1.7, borderLeft: "2px solid #7c3aed", paddingLeft: "14px", marginBottom: "20px" }}>
        ...
        {allChecked && (
          <div>
            <div style={s.feedback("correct")}>
              {`✅ Engine A01 Complete — Components & Decorators mastered.\nNext: Engine A02 — Data Binding (all 4 types)`}
            </div>
            <div style={s.btnRow}>
  ...
  function renderComplete() {
    return (
      <div style={s.completeBanner}>
        ...
        <h1 style={{ ...s.h1, textAlign: "center" }}>Engine A01 Complete</h1>
  ...
  return (
    <div style={s.wrap}>
      ...
      <div style={s.topbar}>
        ...
        <div style={s.engineTag}>A01 — COMPONENTS</div>
