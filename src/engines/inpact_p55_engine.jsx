...
const NODES = [
  { id: "intro", type: "reveal", phase: "Problem", content: { tag: "PROBLEM #55", title: "HOC withAuth", body: "withAuth HOC that redirects unauthenticated users", usecase: "Auth HOC." } },
