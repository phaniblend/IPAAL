...
const NODES = [
  { id: "intro", type: "reveal", phase: "Problem", content: { tag: "PROBLEM #36", title: "usePrevious", body: "Return the previous value of any state using useRef", usecase: "Compare prev vs current." } },
