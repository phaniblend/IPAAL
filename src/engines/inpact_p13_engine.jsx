...
const NODES = [
  { id: "intro", type: "reveal", phase: "Problem", content: { tag: "PROBLEM #13", title: "Props Drilling", body: `Pass data 3 levels deep without Context. Build a small tree: App → Layer1 → Layer2 → Layer3, and pass a value (e.g. theme or user) from App down so Layer3 can display it. You'll see why passing through every layer gets tedious — Context fixes that later.`, usecase: "Understanding props drilling motivates Context and state management." } },
