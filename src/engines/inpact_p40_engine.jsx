...
const NODES = [
  { id: "intro", type: "reveal", phase: "Problem", content: { tag: "PROBLEM #40", title: "useMediaQuery", body: "Return true/false based on a CSS media query string", usecase: "Responsive without CSS-in-JS." } },
