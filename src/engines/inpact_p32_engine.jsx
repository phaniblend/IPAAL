...
const NODES = [
  { id: "intro", type: "reveal", phase: "Problem", content: { tag: "PROBLEM #32", title: "useDebounce", body: "Debounce any value by a configurable delay", usecase: "Reduces API calls when user types." } },
