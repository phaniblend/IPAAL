...
const NODES = [
  { id: "intro", type: "reveal", phase: "Problem", content: { tag: "PROBLEM #37", title: "useClickOutside", body: "Detect clicks outside a referenced element — dropdowns/modals", usecase: "Close on outside click." } },
