...
const NODES = [
  { id: "intro", type: "reveal", phase: "Problem", content: { tag: "PROBLEM #34", title: "useToggle", body: "Generic boolean toggle hook with optional initial value", usecase: "Modals, accordions, on/off state." } },
