...
const NODES = [
  { id: "intro", type: "reveal", phase: "Problem", content: { tag: "PROBLEM #60", title: "Recursive TreeView", body: "Recursive TreeView for nested folders", usecase: "Recursive components." } },
