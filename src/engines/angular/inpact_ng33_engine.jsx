...
const NODES = [
  { id: "intro", type: "reveal", phase: "Lesson", content: { tag: "LESSON #33 (Angular)", title: "useLocalStorage", body: "Sync state with localStorage — read on mount, write on change", usecase: "Same concept as React — implemented with Angular (signals, standalone components)." } },
