...
const NODES = [
  { id: "intro", type: "reveal", phase: "Lesson", content: { tag: "LESSON #43 (Angular)", title: "Cart Context", body: "Shopping cart: add, remove, update quantity, total price", usecase: "Same concept as React — implemented with Angular (signals, standalone components)." } },
