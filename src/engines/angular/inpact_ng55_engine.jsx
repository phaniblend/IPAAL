...
const NODES = [
  { id: "intro", type: "reveal", phase: "Lesson", content: { tag: "LESSON #55 (Angular)", title: "HOC withAuth", body: "withAuth HOC that redirects unauthenticated users", usecase: "Same concept as React — implemented with Angular (signals, standalone components)." } },
