...
const NODES = [
  { id: "intro", type: "reveal", phase: "Problem", content: { tag: "PROBLEM #18 (Angular)", title: "PropTypes / TypeScript Interface", body: "Add TypeScript interfaces to a UserCard component. Define an interface for the props (e.g. name: string, age: number, avatar?: string) and use it to type the component. If using JS, use PropTypes instead.", usecase: "Same concept as React — implemented with Angular (signals, standalone components)." } },
