...
const NODES = [
  { id: "intro", type: "reveal", phase: "Lesson", content: { tag: "LESSON #84 (Angular)", title: "Component Library Theming", body: "Token-based theming with CSS variables + Context", usecase: "Same concept as React — implemented with Angular (signals, standalone components)." } },
