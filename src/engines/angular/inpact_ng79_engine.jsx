...
const NODES = [
  { id: "intro", type: "reveal", phase: "Lesson", content: { tag: "LESSON #79 (Angular)", title: "Polling Hook", body: "usePolling: refetch on interval, stop on unmount", usecase: "Same concept as React — implemented with Angular (signals, standalone components)." } },
