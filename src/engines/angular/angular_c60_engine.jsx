...
const NODES = [
  { id: "intro", type: "reveal", phase: "Problem", content: { tag: "PROBLEM #60 (Angular)", title: TITLE, body: "Render a tree of nodes where each node can have children: create a recursive component that has a template with *ngFor for children and includes itself (or a tree-node component) for each child so the tree is recursive.", usecase: "Angular recursive components use the same component in its own template with *ngFor over children." } },
...
export default createINPACTEngine({ NODES, sideItems, problemNum: 60, title: TITLE, shortName: "A — TREE VIEW" });
