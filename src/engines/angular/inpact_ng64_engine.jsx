...
const NODES = [
  { id: "intro", type: "reveal", phase: "Lesson", content: { tag: "LESSON #64 (Angular)", title: "Multi-Step Form", body: "3-step form with validation, back/next, persisted state", usecase: "Same concept as React — implemented with Angular (signals, standalone components)." } },
