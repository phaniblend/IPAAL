...
const NODES = [
  { id: "intro", type: "reveal", phase: "Lesson", content: { tag: "LESSON #38 (Angular)", title: "useKeyPress", body: "Detect when a specific keyboard key is pressed", usecase: "Same concept as React — implemented with Angular (signals, standalone components)." } },
