...
const NODES = [
  { id: "intro", type: "reveal", phase: "Lesson", content: { tag: "LESSON #77 (Angular)", title: "Optimistic UI", body: "Todo: add item instantly, sync server, rollback on failure", usecase: "Same concept as React — implemented with Angular (signals, standalone components)." } },
