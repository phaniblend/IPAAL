...
const NODES = [
  { id: "intro", type: "reveal", phase: "Problem", content: { tag: "PROBLEM #55 (Angular)", title: TITLE, body: "Wrap a route or component with auth checks in Angular using a route guard (CanActivateFn) that injects AuthService and returns true/false or UrlTree; optionally a wrapper component that injects auth and projects content only when logged in.", usecase: "Angular route guards and optional wrapper components replicate React HOC withAuth for protected content." } },
...
export default createINPACTEngine({ NODES, sideItems, problemNum: 55, title: TITLE, shortName: "A — WITH AUTH" });
