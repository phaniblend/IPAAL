...
const NODES = [
  { id: "intro", type: "reveal", phase: "Lesson", content: { tag: "LESSON #39 (Angular)", title: "useOnlineStatus", body: "Track whether the user is online or offline", usecase: "Same concept as React — implemented with Angular (signals, standalone components)." } },
