...
const NODES = [
  { id: "intro", type: "reveal", phase: "Lesson", content: { tag: "LESSON #93 (Angular)", title: "Test User Interactions", body: "Test multi-step form: fill, Next, submit, success", usecase: "Same concept as React — implemented with Angular (signals, standalone components)." } },
