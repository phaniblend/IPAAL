...
const NODES = [
  { id: "intro", type: "reveal", phase: "Lesson", content: { tag: "LESSON #90 (Angular)", title: "Memory Leak Hunt", body: "Find and fix: listener, interval, subscription not cleaned", usecase: "Same concept as React — implemented with Angular (signals, standalone components)." } },
