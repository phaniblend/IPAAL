...
const NODES = [
  { id: "intro", type: "reveal", phase: "Lesson", content: { tag: "LESSON #72 (Angular)", title: "useSyncExternalStore", body: "Subscribe to external store safely in concurrent mode", usecase: "Same concept as React — implemented with Angular (signals, standalone components)." } },
