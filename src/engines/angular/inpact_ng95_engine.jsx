...
const NODES = [
  { id: "intro", type: "reveal", phase: "Lesson", content: { tag: "LESSON #95 (Angular)", title: "Test Error Boundary", body: "Test that throws in child, assert fallback UI", usecase: "Same concept as React — implemented with Angular (signals, standalone components)." } },
