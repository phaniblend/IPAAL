...
const NODES = [
  { id: "intro", type: "reveal", phase: "Lesson", content: { tag: "LESSON #57 (Angular)", title: "Controlled DatePicker", body: "Fully controlled DatePicker component", usecase: "Same concept as React — implemented with Angular (signals, standalone components)." } },
