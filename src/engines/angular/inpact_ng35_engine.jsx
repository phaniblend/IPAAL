...
const NODES = [
  { id: "intro", type: "reveal", phase: "Lesson", content: { tag: "LESSON #35 (Angular)", title: "useWindowSize", body: "Track window width/height with resize listener and cleanup", usecase: "Same concept as React — implemented with Angular (signals, standalone components)." } },
