...
const NODES = [
  { id: "intro", type: "reveal", phase: "Lesson", content: { tag: "LESSON #91 (Angular)", title: "Test useFetch", body: "Test useFetch with renderHook, mock fetch, loading/error/data", usecase: "Same concept as React — implemented with Angular (signals, standalone components)." } },
