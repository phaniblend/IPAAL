...
const NODES = [
  { id: "intro", type: "reveal", phase: "Lesson", content: { tag: "LESSON #76 (Angular)", title: "Mini Redux", body: "Global state with useReducer + Context + useSelector-style hook", usecase: "Same concept as React — implemented with Angular (signals, standalone components)." } },
