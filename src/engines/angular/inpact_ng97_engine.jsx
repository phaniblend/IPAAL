...
const NODES = [
  { id: "intro", type: "reveal", phase: "Lesson", content: { tag: "LESSON #97 (Angular)", title: "Design Auth Flow", body: "Login, token storage, refresh, protected routes, logout", usecase: "Same concept as React — implemented with Angular (signals, standalone components)." } },
