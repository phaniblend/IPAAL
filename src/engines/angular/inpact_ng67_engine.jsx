...
const NODES = [
  { id: "intro", type: "reveal", phase: "Lesson", content: { tag: "LESSON #67 (Angular)", title: "useRef Typing", body: "Type useRef for DOM element vs mutable value", usecase: "Same concept as React — implemented with Angular (signals, standalone components)." } },
