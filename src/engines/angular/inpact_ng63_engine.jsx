...
const NODES = [
  { id: "intro", type: "reveal", phase: "Lesson", content: { tag: "LESSON #63 (Angular)", title: "Debounced Search", body: "useDebounce + useFetch for real-time search", usecase: "Same concept as React — implemented with Angular (signals, standalone components)." } },
