...
const NODES = [
  { id: "intro", type: "reveal", phase: "Lesson", content: { tag: "LESSON #82 (Angular)", title: "Undo/Redo", body: "Undo/redo for text editor with useReducer + history stack", usecase: "Same concept as React — implemented with Angular (signals, standalone components)." } },
