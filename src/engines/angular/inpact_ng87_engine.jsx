...
const NODES = [
  { id: "intro", type: "reveal", phase: "Lesson", content: { tag: "LESSON #87 (Angular)", title: "Memoization Strategy", body: "Dashboard with 20 widgets — memoization strategy", usecase: "Same concept as React — implemented with Angular (signals, standalone components)." } },
