...
const NODES = [
  { id: "intro", type: "reveal", phase: "Lesson", content: { tag: "LESSON #92 (Angular)", title: "Test Async Component", body: "Test fetch component with msw, assert loading → data", usecase: "Same concept as React — implemented with Angular (signals, standalone components)." } },
