...
const NODES = [
  { id: "intro", type: "reveal", phase: "Lesson", content: { tag: "LESSON #54 (Angular)", title: "Image Lazy Loading", body: "Image loads when in viewport (IntersectionObserver)", usecase: "Same concept as React — implemented with Angular (signals, standalone components)." } },
