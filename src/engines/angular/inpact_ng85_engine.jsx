...
const NODES = [
  { id: "intro", type: "reveal", phase: "Lesson", content: { tag: "LESSON #85 (Angular)", title: "Micro-frontend Shell", body: "Sketch React as micro-frontend with Module Federation", usecase: "Same concept as React — implemented with Angular (signals, standalone components)." } },
