...
const NODES = [
  { id: "intro", type: "reveal", phase: "Lesson", content: { tag: "LESSON #88 (Angular)", title: "Bundle Analysis", body: "Webpack Bundle Analyzer + code splitting for slow load", usecase: "Same concept as React — implemented with Angular (signals, standalone components)." } },
