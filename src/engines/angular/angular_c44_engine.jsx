...
const NODES = [
  { id: "intro", type: "reveal", phase: "Problem", content: { tag: "PROBLEM #44 (Angular)", title: TITLE, body: "Provide a global notification list and add/remove methods via an injectable NotificationService; render toasts in a single outlet component that injects the service.", usecase: "Angular uses a root NotificationService and a toast container component instead of React Context for notifications." } },
...
export default createINPACTEngine({ NODES, sideItems, problemNum: 44, title: TITLE, shortName: "A — NOTIFICATION" });
