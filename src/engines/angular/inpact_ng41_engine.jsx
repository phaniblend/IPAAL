...
const NODES = [
  { id: "intro", type: "reveal", phase: "Lesson", content: { tag: "LESSON #41 (Angular)", title: "Theme Context", body: "Dark/light mode toggle using Context + useReducer", usecase: "Same concept as React — implemented with Angular (signals, standalone components)." } },
