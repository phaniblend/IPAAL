...
const NODES = [
  { id: "intro", type: "reveal", phase: "Lesson", content: { tag: "LESSON #60 (Angular)", title: "Recursive TreeView", body: "Recursive TreeView for nested folders", usecase: "Same concept as React — implemented with Angular (signals, standalone components)." } },
