...
const NODES = [
  { id: "intro", type: "reveal", phase: "Lesson", content: { tag: "LESSON #40 (Angular)", title: "useMediaQuery", body: "Return true/false based on a CSS media query string", usecase: "Same concept as React — implemented with Angular (signals, standalone components)." } },
