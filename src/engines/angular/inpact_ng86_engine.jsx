...
const NODES = [
  { id: "intro", type: "reveal", phase: "Lesson", content: { tag: "LESSON #86 (Angular)", title: "Race Condition Fix", body: "Fix stale API overwriting fresh — AbortController", usecase: "Same concept as React — implemented with Angular (signals, standalone components)." } },
