...
const NODES = [
  { id: "intro", type: "reveal", phase: "Lesson", content: { tag: "LESSON #74 (Angular)", title: "useDeferredValue", body: "Defer expensive re-render, keep input responsive", usecase: "Same concept as React — implemented with Angular (signals, standalone components)." } },
