...
const NODES = [
  { id: "intro", type: "reveal", phase: "Lesson", content: { tag: "LESSON #52 (Angular)", title: "List Virtualization", body: "Windowing for 10,000 items (e.g. react-window)", usecase: "Same concept as React — implemented with Angular (signals, standalone components)." } },
