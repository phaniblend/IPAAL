...
const NODES = [
  { id: "intro", type: "reveal", phase: "Lesson", content: { tag: "LESSON #59 (Angular)", title: "Error Boundary", body: "Class-based Error Boundary with fallback UI", usecase: "Same concept as React — implemented with Angular (signals, standalone components)." } },
