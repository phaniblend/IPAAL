...
const NODES = [
  { id: "intro", type: "reveal", phase: "Lesson", content: { tag: "LESSON #80 (Angular)", title: "WebSocket Hook", body: "useWebSocket: connect, reconnect, send + last message", usecase: "Same concept as React — implemented with Angular (signals, standalone components)." } },
