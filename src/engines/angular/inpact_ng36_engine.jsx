...
const NODES = [
  { id: "intro", type: "reveal", phase: "Lesson", content: { tag: "LESSON #36 (Angular)", title: "usePrevious", body: "Return the previous value of any state using useRef", usecase: "Same concept as React — implemented with Angular (signals, standalone components)." } },
