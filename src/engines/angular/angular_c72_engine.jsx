...
const NODES = [
  { id: "intro", type: "reveal", phase: "Problem", content: { tag: "PROBLEM #72 (Angular)", title: TITLE, body: "Subscribe to external store (e.g. a BehaviorSubject or Redux-like store) in Angular using toSignal(store$.asObservable()) so the component gets reactive updates; the store can be a service with getState() and subscribe().", usecase: "Angular toSignal over an external Observable replicates useSyncExternalStore for store subscription." } },
...
export default createINPACTEngine({ NODES, sideItems, problemNum: 72, title: TITLE, shortName: "A — SYNC EXTERNAL STORE" });
