...
const NODES = [
  { id: "intro", type: "reveal", phase: "Lesson", content: { tag: "LESSON #71 (Angular)", title: "useImperativeHandle", body: "Expose focus()/clear() from child via forwardRef + useImperativeHandle", usecase: "Same concept as React — implemented with Angular (signals, standalone components)." } },
