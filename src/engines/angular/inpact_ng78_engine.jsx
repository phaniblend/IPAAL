...
const NODES = [
  { id: "intro", type: "reveal", phase: "Lesson", content: { tag: "LESSON #78 (Angular)", title: "Request Deduplication", body: "Fetch layer that prevents duplicate in-flight same URL", usecase: "Same concept as React — implemented with Angular (signals, standalone components)." } },
