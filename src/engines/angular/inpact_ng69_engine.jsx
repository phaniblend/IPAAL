...
const NODES = [
  { id: "intro", type: "reveal", phase: "Lesson", content: { tag: "LESSON #69 (Angular)", title: "Generic useFetch<T>", body: "Add generics to useFetch for typed responses", usecase: "Same concept as React — implemented with Angular (signals, standalone components)." } },
