...
const NODES = [
  { id: "intro", type: "reveal", phase: "Problem", content: { tag: "PROBLEM #7 (Angular)", title: "useEffect & Side Effects", body: "Run a side effect when a signal or input changes. In Angular we use effect() from @angular/core to react to signal changes (similar to React useEffect).", usecase: "effect() runs when its read signals change — use for logging, syncing, or external APIs." } },
...
export default createINPACTEngine({ NODES, sideItems, problemNum: 7, title: "useEffect & Side Effects (Angular)", shortName: "A — EFFECT" });
