...
const NODES = [
  { id: "intro", type: "reveal", phase: "Problem", content: { tag: "PROBLEM #54 (Angular)", title: TITLE, body: "Defer loading images until they're near the viewport using the native loading=\"lazy\" attribute or Angular's NgOptimizedImage directive with priority and loading attributes.", usecase: "Angular NgOptimizedImage and loading=\"lazy\" provide image lazy loading for better performance." } },
