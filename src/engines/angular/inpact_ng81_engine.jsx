...
const NODES = [
  { id: "intro", type: "reveal", phase: "Lesson", content: { tag: "LESSON #81 (Angular)", title: "Feature Flag Hook", body: "useFeatureFlag(flagName) from context", usecase: "Same concept as React — implemented with Angular (signals, standalone components)." } },
