...
const NODES = [
  { id: "intro", type: "reveal", phase: "Problem", content: { tag: "PROBLEM #100 (Angular)", title: TITLE, body: "Design a real-time dashboard in Angular: use WebSocket or Server-Sent Events to push data; hold metrics in signals (e.g. metrics = signal({ users: 0, orders: 0 })); update signals when messages arrive; layout with grid or cards that bind to metrics().", usecase: "Angular WebSocket/SSE service and signals power a real-time dashboard that updates live." } },
...
export default createINPACTEngine({ NODES, sideItems, problemNum: 100, title: TITLE, shortName: "A — REAL-TIME DASHBOARD" });
