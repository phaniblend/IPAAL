...
const NODES = [
  { id: "intro", type: "reveal", phase: "Lesson", content: { tag: "LESSON #46 (Angular)", title: "useReducer vs useState", body: "Refactor multi-field form from useState to useReducer", usecase: "Same concept as React — implemented with Angular (signals, standalone components)." } },
