...
const NODES = [
  { id: "intro", type: "reveal", phase: "Lesson", content: { tag: "LESSON #1 (Angular)", title: "Counter App", body: "Build a very simple React page that displays a number starting at 0 and lets the user change it using buttons: [ + ] increases the number by 1 [ - ] decreases the number by 1 [ Reset ] brings the number back to 0 Example: Start → 0 Click + → 1 Click + → 2 Click - → 1 Click Reset → 0", usecase: "Same concept as React — implemented with Angular (signals, standalone components)." } },
