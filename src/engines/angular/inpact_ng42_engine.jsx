...
const NODES = [
  { id: "intro", type: "reveal", phase: "Lesson", content: { tag: "LESSON #42 (Angular)", title: "Auth Context", body: "Mock auth: login, logout, protected route, user in context", usecase: "Same concept as React — implemented with Angular (signals, standalone components)." } },
