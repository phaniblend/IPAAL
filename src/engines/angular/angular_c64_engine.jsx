...
const NODES = [
  { id: "intro", type: "reveal", phase: "Problem", content: { tag: "PROBLEM #64 (Angular)", title: TITLE, body: "Build a wizard with multiple steps: currentStep signal, form state (ReactiveFormsModule or signals), and Next/Back buttons that validate and move between steps; show step content with *ngIf or *ngSwitch.", usecase: "Angular signals and ReactiveFormsModule (or FormGroup) implement multi-step forms with validation." } },
...
export default createINPACTEngine({ NODES, sideItems, problemNum: 64, title: TITLE, shortName: "A — MULTI-STEP FORM" });
