...
const NODES = [
  { id: "intro", type: "reveal", phase: "Lesson", content: { tag: "LESSON #44 (Angular)", title: "Notification Context", body: "Toast system: push, auto-dismiss, stack limit", usecase: "Same concept as React — implemented with Angular (signals, standalone components)." } },
