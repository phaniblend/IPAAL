...
const NODES = [
  { id: "intro", type: "reveal", phase: "Lesson", content: { tag: "LESSON #32 (Angular)", title: "useDebounce", body: "Debounce any value by a configurable delay", usecase: "Same concept as React — implemented with Angular (signals, standalone components)." } },
