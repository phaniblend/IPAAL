...
const NODES = [
  { id: "intro", type: "reveal", phase: "Lesson", content: { tag: "LESSON #89 (Angular)", title: "Concurrent Mode Gotchas", body: "Explain tearing and useSyncExternalStore", usecase: "Same concept as React — implemented with Angular (signals, standalone components)." } },
