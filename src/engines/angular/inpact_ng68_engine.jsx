...
const NODES = [
  { id: "intro", type: "reveal", phase: "Lesson", content: { tag: "LESSON #68 (Angular)", title: "Event Typing", body: "Type onChange, onClick, onSubmit in TypeScript", usecase: "Same concept as React — implemented with Angular (signals, standalone components)." } },
