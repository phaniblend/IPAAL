...
const NODES = [
  { id: "intro", type: "reveal", phase: "Problem", content: { tag: "PROBLEM #76 (Angular)", title: TITLE, body: "Implement a minimal Redux-like store in Angular: a service with a BehaviorSubject for state, dispatch(action) that runs a reducer and calls state.next(newState), and components use toSignal(store.state$) to read state.", usecase: "Angular service with reducer and BehaviorSubject replicates a mini Redux pattern." } },
...
export default createINPACTEngine({ NODES, sideItems, problemNum: 76, title: TITLE, shortName: "A — MINI REDUX" });
