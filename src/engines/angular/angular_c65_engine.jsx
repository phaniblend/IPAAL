...
const NODES = [
  { id: "intro", type: "reveal", phase: "Problem", content: { tag: "PROBLEM #65 (Angular)", title: TITLE, body: "Create a reusable list component that accepts a generic type T: @Input() items: T[] and @Input() trackBy or a template for rendering each item using ng-template with TemplateRef so the parent can define how each T is displayed.", usecase: "Angular generic components use TypeScript generics and TemplateRef for flexible list rendering." } },
...
export default createINPACTEngine({ NODES, sideItems, problemNum: 65, title: TITLE, shortName: "A — GENERIC LIST" });
