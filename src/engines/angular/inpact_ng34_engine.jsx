...
const NODES = [
  { id: "intro", type: "reveal", phase: "Lesson", content: { tag: "LESSON #34 (Angular)", title: "useToggle", body: "Generic boolean toggle hook with optional initial value", usecase: "Same concept as React — implemented with Angular (signals, standalone components)." } },
