...
const NODES = [
  { id: "intro", type: "reveal", phase: "Problem", content: { tag: "PROBLEM #68 (Angular)", title: TITLE, body: "Type DOM and custom events in Angular: use (click)=\"onClick($event)\" with $event typed as MouseEvent, (input)=\"onInput($event)\" with Event or InputEvent, and EventEmitter<Payload> for @Output() with a specific payload type.", usecase: "Angular templates pass $event; type handler params as MouseEvent, KeyboardEvent, etc., and EventEmitter<T> for outputs." } },
...
export default createINPACTEngine({ NODES, sideItems, problemNum: 68, title: TITLE, shortName: "A — EVENT TYPING" });
