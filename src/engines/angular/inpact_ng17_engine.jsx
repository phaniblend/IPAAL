...
const NODES = [
  { id: "intro", type: "reveal", phase: "Problem", content: { tag: "PROBLEM #17 (Angular)", title: "List Rendering", body: "Render a list of products with proper key props. Use an array of objects (e.g. id, name, price) and map over it to render a div or li for each. Keys help React track list items across updates.", usecase: "Same concept as React — implemented with Angular (signals, standalone components)." } },
