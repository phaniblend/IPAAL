...
const NODES = [
  { id: "intro", type: "reveal", phase: "Lesson", content: { tag: "LESSON #61 (Angular)", title: "Pagination", body: "Client-side pagination for 100 items", usecase: "Same concept as React — implemented with Angular (signals, standalone components)." } },
