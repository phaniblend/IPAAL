...
const NODES = [
  { id: "intro", type: "reveal", phase: "Lesson", content: { tag: "LESSON #62 (Angular)", title: "Infinite Scroll", body: "Load more on scroll (IntersectionObserver)", usecase: "Same concept as React — implemented with Angular (signals, standalone components)." } },
