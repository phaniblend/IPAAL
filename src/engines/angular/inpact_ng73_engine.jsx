...
const NODES = [
  { id: "intro", type: "reveal", phase: "Lesson", content: { tag: "LESSON #73 (Angular)", title: "useTransition", body: "Mark slow update non-urgent — heavy filtered list demo", usecase: "Same concept as React — implemented with Angular (signals, standalone components)." } },
