...
const NODES = [
  { id: "intro", type: "reveal", phase: "Lesson", content: { tag: "LESSON #51 (Angular)", title: "React.memo", body: "Wrap pure child; demonstrate it stops re-rendering", usecase: "Same concept as React — implemented with Angular (signals, standalone components)." } },
