...
const NODES = [
  { id: "intro", type: "reveal", phase: "Problem", content: { tag: "PROBLEM #58", title: "Portal", body: "Render modal outside root with ReactDOM.createPortal", usecase: "Portals." } },
