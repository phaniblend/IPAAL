...
const NODES = [
  { id: "intro", type: "reveal", phase: "Problem", content: { tag: "PROBLEM #81", title: "Feature Flag Hook", body: "useFeatureFlag(flagName) from context", usecase: "Feature flags." } },
