...
const NODES = [
  { id: "intro", type: "reveal", phase: "Problem", content: { tag: "PROBLEM #63", title: "Debounced Search", body: "useDebounce + useFetch for real-time search", usecase: "Search UX." } },
