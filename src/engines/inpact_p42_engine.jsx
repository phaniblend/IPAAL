...
const NODES = [
  { id: "intro", type: "reveal", phase: "Problem", content: { tag: "PROBLEM #42", title: "Auth Context", body: "Mock auth: login, logout, protected route, user in context", usecase: "Auth state and guards." } },
