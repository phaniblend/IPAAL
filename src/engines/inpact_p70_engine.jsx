...
const NODES = [
  { id: "intro", type: "reveal", phase: "Problem", content: { tag: "PROBLEM #70", title: "Utility Types", body: "Use Partial, Pick, Omit for prop interfaces", usecase: "Utility types." } },
