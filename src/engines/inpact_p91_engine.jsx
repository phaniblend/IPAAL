...
const NODES = [
  { id: "intro", type: "reveal", phase: "Problem", content: { tag: "PROBLEM #91", title: "Test useFetch", body: "Test useFetch with renderHook, mock fetch, loading/error/data", usecase: "Test hooks." } },
