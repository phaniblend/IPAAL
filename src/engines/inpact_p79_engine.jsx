...
const NODES = [
  { id: "intro", type: "reveal", phase: "Problem", content: { tag: "PROBLEM #79", title: "Polling Hook", body: "usePolling: refetch on interval, stop on unmount", usecase: "Polling." } },
