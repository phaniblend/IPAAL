...
const NODES = [
  { id: "intro", type: "reveal", phase: "Problem", content: { tag: "PROBLEM #86", title: "Race Condition Fix", body: "Fix stale API overwriting fresh — AbortController", usecase: "Race conditions." } },
