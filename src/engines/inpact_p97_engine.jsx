...
const NODES = [
  { id: "intro", type: "reveal", phase: "Problem", content: { tag: "PROBLEM #97", title: "Design Auth Flow", body: "Login, token storage, refresh, protected routes, logout", usecase: "Auth design." } },
