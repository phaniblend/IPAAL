...
const NODES = [
  { id: "intro", type: "reveal", phase: "Problem", content: { tag: "PROBLEM #31", title: "useFetch", body: "Custom hook for data fetching with loading/error/data + AbortController cleanup", usecase: "Reusable fetch with cleanup avoids leaks." } },
