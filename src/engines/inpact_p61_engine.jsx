...
const NODES = [
  { id: "intro", type: "reveal", phase: "Problem", content: { tag: "PROBLEM #61", title: "Pagination", body: "Client-side pagination for 100 items", usecase: "Pagination." } },
