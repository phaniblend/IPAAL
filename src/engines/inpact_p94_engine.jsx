...
const NODES = [
  { id: "intro", type: "reveal", phase: "Problem", content: { tag: "PROBLEM #94", title: "Test Context", body: "Test component consuming Auth Context with mock provider", usecase: "Test context." } },
