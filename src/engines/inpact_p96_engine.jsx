...
const NODES = [
  { id: "intro", type: "reveal", phase: "Problem", content: { tag: "PROBLEM #96", title: "Design DataTable API", body: "Design props for sortable, filterable, paginated table", usecase: "API design." } },
