...
const NODES = [
  { id: "intro", type: "reveal", phase: "Problem", content: { tag: "PROBLEM #72", title: "useSyncExternalStore", body: "Subscribe to external store safely in concurrent mode", usecase: "External store." } },
