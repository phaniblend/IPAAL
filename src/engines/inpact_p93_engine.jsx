...
const NODES = [
  { id: "intro", type: "reveal", phase: "Problem", content: { tag: "PROBLEM #93", title: "Test User Interactions", body: "Test multi-step form: fill, Next, submit, success", usecase: "Test interactions." } },
