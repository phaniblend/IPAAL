...
const NODES = [
  { id: "intro", type: "reveal", phase: "Problem", content: { tag: "PROBLEM #80", title: "WebSocket Hook", body: "useWebSocket: connect, reconnect, send + last message", usecase: "WebSocket." } },
