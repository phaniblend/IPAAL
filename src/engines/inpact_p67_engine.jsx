...
const NODES = [
  { id: "intro", type: "reveal", phase: "Problem", content: { tag: "PROBLEM #67", title: "useRef Typing", body: "Type useRef for DOM element vs mutable value", usecase: "Ref typing." } },
