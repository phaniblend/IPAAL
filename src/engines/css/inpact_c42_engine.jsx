...
const NODES = [
  {
    ...
    content: {
      ...
      body: `Senior fullstack devs need a solid grasp of ::before and ::after. This lesson covers the key concepts, common values, and patterns you'll use in production.`,
      usecase: "When implementing layouts, fixing bugs, or matching design specs, you'll often rely on ::before and ::after.",
    },
  },
  {
    id: "objectives",
    ...
    items: ["Understand how ::before and ::after works and when to use it","Apply ::before and ::after in a minimal example","Combine with related properties for real-world layouts"],
  },
  {
    id: "step1",
    type: "question",
