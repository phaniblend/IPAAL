...
const NODES = [
  {
    ...
    content: {
      ...
      body: `Senior fullstack devs need a solid grasp of Attribute selectors. This lesson covers the key concepts, common values, and patterns you'll use in production.`,
      usecase: "When implementing layouts, fixing bugs, or matching design specs, you'll often rely on Attribute selectors.",
    },
  },
  {
    id: "objectives",
    ...
    items: ["Understand how Attribute selectors works and when to use it","Apply Attribute selectors in a minimal example","Combine with related properties for real-world layouts"],
  },
  {
    id: "step1",
    type: "question",
