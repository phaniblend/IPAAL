...
const NODES = [
  { id: "intro", type: "reveal", phase: "Lesson", content: { tag: "LESSON #88", title: "Bundle Analysis", body: "Webpack Bundle Analyzer + code splitting for slow load", usecase: "Bundle size." } },
