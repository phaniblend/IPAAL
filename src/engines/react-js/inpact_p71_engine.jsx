...
const NODES = [
  { id: "intro", type: "reveal", phase: "Lesson", content: { tag: "LESSON #71", title: "useImperativeHandle", body: "Expose focus()/clear() from child via forwardRef + useImperativeHandle", usecase: "Imperative handle." } },
