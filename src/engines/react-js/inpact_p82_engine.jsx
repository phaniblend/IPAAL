...
const NODES = [
  { id: "intro", type: "reveal", phase: "Lesson", content: { tag: "LESSON #82", title: "Undo/Redo", body: "Undo/redo for text editor with useReducer + history stack", usecase: "Undo redo." } },
