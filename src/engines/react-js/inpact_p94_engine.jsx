...
const NODES = [
  { id: "intro", type: "reveal", phase: "Lesson", content: { tag: "LESSON #94", title: "Test Context", body: "Test component consuming Auth Context with mock provider", usecase: "Test context." } },
