...
const NODES = [
  { id: "intro", type: "reveal", phase: "Lesson", content: { tag: "LESSON #46", title: "useReducer vs useState", body: "Refactor multi-field form from useState to useReducer", usecase: "Complex form state." } },
