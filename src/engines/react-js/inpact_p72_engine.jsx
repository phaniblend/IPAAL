...
const NODES = [
  { id: "intro", type: "reveal", phase: "Lesson", content: { tag: "LESSON #72", title: "useSyncExternalStore", body: "Subscribe to external store safely in concurrent mode", usecase: "External store." } },
