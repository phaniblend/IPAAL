...
const NODES = [
  { id: "intro", type: "reveal", phase: "Lesson", content: { tag: "LESSON #45", title: "Context Performance", body: "Fix Context that re-renders entire tree — split or memo", usecase: "Avoid over-renders." } },
