...
const NODES = [
  { id: "intro", type: "reveal", phase: "Lesson", content: { tag: "LESSON #41", title: "Theme Context", body: "Dark/light mode toggle using Context + useReducer", usecase: "Global theme state." } },
