...
const NODES = [
  { id: "intro", type: "reveal", phase: "Lesson", content: { tag: "LESSON #48", title: "Unnecessary Re-renders", body: "Fix performance bug with React.memo, useMemo, useCallback", usecase: "Stop re-renders." } },
