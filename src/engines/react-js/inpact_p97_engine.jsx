...
const NODES = [
  { id: "intro", type: "reveal", phase: "Lesson", content: { tag: "LESSON #97", title: "Design Auth Flow", body: "Login, token storage, refresh, protected routes, logout", usecase: "Auth design." } },
