...
const NODES = [
  { id: "intro", type: "reveal", phase: "Lesson", content: { tag: "LESSON #90", title: "Memory Leak Hunt", body: "Find and fix: listener, interval, subscription not cleaned", usecase: "Memory leaks." } },
