...
const NODES = [
  { id: "intro", type: "reveal", phase: "Lesson", content: { tag: "LESSON #33", title: "useLocalStorage", body: "Sync state with localStorage — read on mount, write on change", usecase: "Persist preferences across reloads." } },
