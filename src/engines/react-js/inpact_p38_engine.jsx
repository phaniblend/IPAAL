...
const NODES = [
  { id: "intro", type: "reveal", phase: "Lesson", content: { tag: "LESSON #38", title: "useKeyPress", body: "Detect when a specific keyboard key is pressed", usecase: "Shortcuts, escape to close." } },
