...
const NODES = [
  { id: "intro", type: "reveal", phase: "Lesson", content: { tag: "LESSON #49", title: "useMemo for Expensive Computation", body: "Filter + sort large list — memoize the result", usecase: "Expensive compute." } },
