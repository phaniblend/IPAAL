...
const NODES = [
  { id: "intro", type: "reveal", phase: "Lesson", content: { tag: "LESSON #86", title: "Race Condition Fix", body: "Fix stale API overwriting fresh — AbortController", usecase: "Race conditions." } },
