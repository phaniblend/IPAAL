...
const NODES = [
  { id: "intro", type: "reveal", phase: "Lesson", content: { tag: "LESSON #74", title: "useDeferredValue", body: "Defer expensive re-render, keep input responsive", usecase: "Deferred value." } },
