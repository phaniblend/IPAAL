...
const NODES = [
  { id: "intro", type: "reveal", phase: "Lesson", content: { tag: "LESSON #42", title: "Auth Context", body: "Mock auth: login, logout, protected route, user in context", usecase: "Auth state and guards." } },
