...
const NODES = [
  { id: "intro", type: "reveal", phase: "Lesson", content: { tag: "LESSON #95", title: "Test Error Boundary", body: "Test that throws in child, assert fallback UI", usecase: "Test error boundary." } },
