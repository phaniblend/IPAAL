...
const NODES = [
  { id: "intro", type: "reveal", phase: "Lesson", content: { tag: "LESSON #76", title: "Mini Redux", body: "Global state with useReducer + Context + useSelector-style hook", usecase: "Mini Redux." } },
