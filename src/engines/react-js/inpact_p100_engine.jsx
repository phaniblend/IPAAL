...
const NODES = [
  { id: "intro", type: "reveal", phase: "Lesson", content: { tag: "LESSON #100", title: "Design Real-Time Dashboard", body: "Poll 5 endpoints, intervals, stale indicators, errors", usecase: "Dashboard design." } },
