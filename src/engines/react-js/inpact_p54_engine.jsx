...
const NODES = [
  { id: "intro", type: "reveal", phase: "Lesson", content: { tag: "LESSON #54", title: "Image Lazy Loading", body: "Image loads when in viewport (IntersectionObserver)", usecase: "Lazy images." } },
