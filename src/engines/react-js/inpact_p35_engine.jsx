...
const NODES = [
  { id: "intro", type: "reveal", phase: "Lesson", content: { tag: "LESSON #35", title: "useWindowSize", body: "Track window width/height with resize listener and cleanup", usecase: "Responsive layouts." } },
