...
const NODES = [
  { id: "intro", type: "reveal", phase: "Lesson", content: { tag: "LESSON #69", title: "Generic useFetch<T>", body: "Add generics to useFetch for typed responses", usecase: "Generic hooks." } },
