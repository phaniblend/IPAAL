...
const NODES = [
  { id: "intro", type: "reveal", phase: "Lesson", content: { tag: "LESSON #53", title: "Lazy Loading Routes", body: "Code splitting with React.lazy + Suspense on routes", usecase: "Lazy routes." } },
