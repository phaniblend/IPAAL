...
const NODES = [
  { id: "intro", type: "reveal", phase: "Lesson", content: { tag: "LESSON #57", title: "Controlled DatePicker", body: "Fully controlled DatePicker component", usecase: "Controlled pattern." } },
