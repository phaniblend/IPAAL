...
const NODES = [
  { id: "intro", type: "reveal", phase: "Lesson", content: { tag: "LESSON #59", title: "Error Boundary", body: "Class-based Error Boundary with fallback UI", usecase: "Error boundaries." } },
