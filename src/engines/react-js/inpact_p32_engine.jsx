...
const NODES = [
  { id: "intro", type: "reveal", phase: "Lesson", content: { tag: "LESSON #32", title: "useDebounce", body: "Debounce any value by a configurable delay", usecase: "Reduces API calls when user types." } },
