...
const NODES = [
  { id: "intro", type: "reveal", phase: "Lesson", content: { tag: "LESSON #39", title: "useOnlineStatus", body: "Track whether the user is online or offline", usecase: "Show banner when offline." } },
