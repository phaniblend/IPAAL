...
const NODES = [
  { id: "intro", type: "reveal", phase: "Lesson", content: { tag: "LESSON #83", title: "Form Library from Scratch", body: "Mini useForm: register, values/errors/touched, submit", usecase: "useForm." } },
