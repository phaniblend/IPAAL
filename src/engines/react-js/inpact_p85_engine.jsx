...
const NODES = [
  { id: "intro", type: "reveal", phase: "Lesson", content: { tag: "LESSON #85", title: "Micro-frontend Shell", body: "Sketch React as micro-frontend with Module Federation", usecase: "Micro-frontends." } },
