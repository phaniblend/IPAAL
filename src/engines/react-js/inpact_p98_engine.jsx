...
const NODES = [
  { id: "intro", type: "reveal", phase: "Lesson", content: { tag: "LESSON #98", title: "Design Notification System", body: "Toasts: types, auto-dismiss, max 3, queue", usecase: "Notification design." } },
