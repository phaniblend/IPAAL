...
const NODES = [
  { id: "intro", type: "reveal", phase: "Lesson", content: { tag: "LESSON #40", title: "useMediaQuery", body: "Return true/false based on a CSS media query string", usecase: "Responsive without CSS-in-JS." } },
