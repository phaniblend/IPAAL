...
const NODES = [
  { id: "intro", type: "reveal", phase: "Lesson", content: { tag: "LESSON #87", title: "Memoization Strategy", body: "Dashboard with 20 widgets — memoization strategy", usecase: "Memo strategy." } },
