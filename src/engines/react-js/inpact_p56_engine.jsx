...
const NODES = [
  { id: "intro", type: "reveal", phase: "Lesson", content: { tag: "LESSON #56", title: "Render Props (MouseTracker)", body: "MouseTracker using render props pattern", usecase: "Render props." } },
