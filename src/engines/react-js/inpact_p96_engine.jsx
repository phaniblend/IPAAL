...
const NODES = [
  { id: "intro", type: "reveal", phase: "Lesson", content: { tag: "LESSON #96", title: "Design DataTable API", body: "Design props for sortable, filterable, paginated table", usecase: "API design." } },
