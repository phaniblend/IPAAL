...
const NODES = [
  { id: "intro", type: "reveal", phase: "Lesson", content: { tag: "LESSON #75", title: "useLayoutEffect vs useEffect", body: "Explain difference with DOM measurement example", usecase: "Layout effect." } },
