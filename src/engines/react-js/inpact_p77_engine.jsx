...
const NODES = [
  { id: "intro", type: "reveal", phase: "Lesson", content: { tag: "LESSON #77", title: "Optimistic UI", body: "Todo: add item instantly, sync server, rollback on failure", usecase: "Optimistic updates." } },
