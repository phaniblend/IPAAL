...
const NODES = [
  { id: "intro", type: "reveal", phase: "Lesson", content: { tag: "LESSON #36", title: "usePrevious", body: "Return the previous value of any state using useRef", usecase: "Compare prev vs current." } },
