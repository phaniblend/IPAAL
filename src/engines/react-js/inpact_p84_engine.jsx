...
const NODES = [
  { id: "intro", type: "reveal", phase: "Lesson", content: { tag: "LESSON #84", title: "Component Library Theming", body: "Token-based theming with CSS variables + Context", usecase: "Theming." } },
