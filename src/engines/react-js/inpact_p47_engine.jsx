...
const NODES = [
  { id: "intro", type: "reveal", phase: "Lesson", content: { tag: "LESSON #47", title: "Compound Component (Tabs)", body: "Tabs component with Context so Tab children know active state", usecase: "Tabs + Context." } },
