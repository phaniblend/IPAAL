...
const NODES = [
  { id: "intro", type: "reveal", phase: "Lesson", content: { tag: "LESSON #99", title: "Design Permission System", body: "Can action resource component, roles data model", usecase: "Permissions." } },
