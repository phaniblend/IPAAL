...
const NODES = [
  { id: "intro", type: "reveal", phase: "Lesson", content: { tag: "LESSON #43", title: "Cart Context", body: "Shopping cart: add, remove, update quantity, total price", usecase: "Global cart state." } },
