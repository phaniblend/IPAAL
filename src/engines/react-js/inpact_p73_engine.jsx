...
const NODES = [
  { id: "intro", type: "reveal", phase: "Lesson", content: { tag: "LESSON #73", title: "useTransition", body: "Mark slow update non-urgent — heavy filtered list demo", usecase: "Transitions." } },
