...
const NODES = [
  { id: "intro", type: "reveal", phase: "Lesson", content: { tag: "LESSON #93", title: "Test User Interactions", body: "Test multi-step form: fill, Next, submit, success", usecase: "Test interactions." } },
