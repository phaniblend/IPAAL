...
const NODES = [
  { id: "intro", type: "reveal", phase: "Lesson", content: { tag: "LESSON #34", title: "useToggle", body: "Generic boolean toggle hook with optional initial value", usecase: "Modals, accordions, on/off state." } },
