...
const NODES = [
  { id: "intro", type: "reveal", phase: "Lesson", content: { tag: "LESSON #37", title: "useClickOutside", body: "Detect clicks outside a referenced element — dropdowns/modals", usecase: "Close on outside click." } },
