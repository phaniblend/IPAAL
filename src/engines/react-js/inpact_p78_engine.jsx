...
const NODES = [
  { id: "intro", type: "reveal", phase: "Lesson", content: { tag: "LESSON #78", title: "Request Deduplication", body: "Fetch layer that prevents duplicate in-flight same URL", usecase: "Dedup fetch." } },
