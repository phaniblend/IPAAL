...
const NODES = [
  { id: "intro", type: "reveal", phase: "Lesson", content: { tag: "LESSON #60", title: "Recursive TreeView", body: "Recursive TreeView for nested folders", usecase: "Recursive components." } },
