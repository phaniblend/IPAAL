...
const NODES = [
  { id: "intro", type: "reveal", phase: "Problem", content: { tag: "PROBLEM #73", title: "useTransition", body: "Mark slow update non-urgent — heavy filtered list demo", usecase: "Transitions." } },
