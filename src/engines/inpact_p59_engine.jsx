...
const NODES = [
  { id: "intro", type: "reveal", phase: "Problem", content: { tag: "PROBLEM #59", title: "Error Boundary", body: "Class-based Error Boundary with fallback UI", usecase: "Error boundaries." } },
