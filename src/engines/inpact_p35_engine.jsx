...
const NODES = [
  { id: "intro", type: "reveal", phase: "Problem", content: { tag: "PROBLEM #35", title: "useWindowSize", body: "Track window width/height with resize listener and cleanup", usecase: "Responsive layouts." } },
