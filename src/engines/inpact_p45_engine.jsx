...
const NODES = [
  { id: "intro", type: "reveal", phase: "Problem", content: { tag: "PROBLEM #45", title: "Context Performance", body: "Fix Context that re-renders entire tree — split or memo", usecase: "Avoid over-renders." } },
