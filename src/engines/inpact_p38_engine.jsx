...
const NODES = [
  { id: "intro", type: "reveal", phase: "Problem", content: { tag: "PROBLEM #38", title: "useKeyPress", body: "Detect when a specific keyboard key is pressed", usecase: "Shortcuts, escape to close." } },
